...
import Logosection2 from "../components/logo-section-2";

const Homepage = () => {
  return (
    // <section>
    <section className="relative w-full h-full overflow-hidden text-center bg-white text-20xl-2 text-heading-text-color font-inter">
      <Backstyles />
      <Header
        logoText="Logo"
        logoUrl="/home"
      ...
      <section className="flex flex-col items-center gap-80">
        <div className="relative flex items-center justify-center mt-10 lg:mt-8 xl:mt-6 2xl:mt-4 md:mt-20 lg:mt-24 xl:mt-32 2xl:mt-100 md:pt-100">
          <AboutUsContainer
            title="About Us"
      ...
      <section className="flex flex-col items-center justify-center mt-80 mb-20 md:mt-[400px] sm:mt-[650px]  xs:mt-[750px]">
        {" "}
        {/* Adjust mt-20 and mb-20 as per your need */}
        <AboutUsWrapper
          title="About Us"
      ...
      <section className="flex flex-col items-center mt-40 justify">
        <AboutUsExame
          aboutUsText="About Us"
